...
const EditProfile = ({
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      skills:
        loading || !profile.data.skills ? " " : profile.data.skills.join(","),
      bio: loading || !profile.data.bio ? " " : profile.data.bio,
      githubusername:
        loading || !profile.data.githubusername
          ? " "
          : profile.data.githubusername,
      github:
        loading || !profile.data.social ? " " : profile.data.social.github,
      twitter:
        loading || !profile.data.social ? " " : profile.data.social.twitter,
      LinkedIn:
        loading || !profile.data.social ? " " : profile.data.social.LinkedIn,
      instagram:
        loading || !profile.data.social ? " " : profile.data.social.instagram,
      youtube:
        loading || !profile.data.social ? " " : profile.data.social.youtube,
    });
